...
function set_proxy() {
	git config --global http.proxy http://username:password@bcpxy.nycnet:8080
	export http_proxy=http://username:password@bcpxy.nycnet:8080
	export https_proxy=http://username:password@bcpxy.nycnet:8080
