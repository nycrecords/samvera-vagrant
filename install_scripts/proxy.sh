...
function set_proxy() {
	git config --global http.proxy http://***REMOVED***@bcpxy.nycnet:8080
	export http_proxy=http://***REMOVED***@bcpxy.nycnet:8080
	export https_proxy=http://***REMOVED***@bcpxy.nycnet:8080
